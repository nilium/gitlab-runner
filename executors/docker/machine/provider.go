...
func (m *machineProvider) scheduleMachineRemoval(machineName string, reason ...interface{}) error {
	...
	machine, _ := m.machines[machineName]
	if machine == nil {
...
func (m *machineProvider) Use(config *common.RunnerConfig, data common.ExecutorData) (common.RunnerConfig, common.ExecutorData, error) {
	...
	newConfig.Docker.DockerCredentials = dockerCredentials
